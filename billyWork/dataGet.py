...
tkinter.messagebox.showinfo(title="Upload", message="Please choose the Assesment Export from OneTrust")# Popup window explaining about to ask for source workbook
...
tkinter.messagebox.showinfo(title="Upload", message="Please Select the Risk Export Workbook from OneTrust")# Popup window explaining about to ask for source workbook
